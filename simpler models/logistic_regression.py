...
def build_model():
    ...
    model = LogisticRegression(max_iter=2000, C=10.0)
    ...
    print("Accuracy classification score:", accuracy_score(y_test, y_pred))
...
def predict():
    ...
    print("team", y_pred + 1, "wins")
    prediction_prob = model.predict_proba(X)[0]  # probability of win for each team
